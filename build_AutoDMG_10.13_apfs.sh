...
$autoDMG --root --logfile /tmp/autodmg.txt --log-level 7 build "/Applications/$installername" --output /private/tmp/"$osVersion$auto$buildVersion".apfs.dmg --filesystem apfs --updates

#change permissions
chmod 644 /private/tmp/"$osVersion$auto$buildVersion".apfs.dmg
